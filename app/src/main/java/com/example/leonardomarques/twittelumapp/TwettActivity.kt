...
import com.example.leonardomarques.twittelumapp.bancodedados.decodificaParaBase64
...
class TwettActivity : AppCompatActivity() {
    ...
    private fun criaTweet(): Tweet {
        ...
        val campoDeMensagemTweet = findViewById<EditText>(R.id.tweet)

        val mensagemDoTweet : String = campoDeMensagemTweet.text.toString()
